...
const Student = require('../models/DoubtsModel');
...
//https://mydb-fafc.restdb.io/rest/people?q={"name": "Joe"}
// Query a get a list of students from the database
...
// add a student doubt to the teacher database
router.post('/teachers/create',function(req,res,next){
    Student.create(req.body).then(function(student){
        res.send(student);
    }).catch(next);
});
